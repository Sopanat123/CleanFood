...
<html>
    ...
    <body>
        <header id="header">
            <h1><a href="reception.jsp">Clean Food</a></h1>
                            ...
                            <tbody>
                                <c:forEach var="order" items="${orders.rows}" varStatus="loop">
                                    <tr>
                                        <td>${loop.index + 1}</td>
                                        <td>
                                            <button type="submit" name="approved" value="${order.id}">Approve</button>
                                            <button type="submit" name="disapproved" value="${order.id}">Disapprove</button>
                                        </td>
                                        <td>${order.id}</td>
                                        <td>${order.name}</td>
                                        <td>${order.status}</td>
