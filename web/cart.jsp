            ...
            <div id="body">
                ...
                <div id="comments">
                    ...
                    <form action="orderprocess.do" method="post">
                        <h3>Promotion : XXX</h3>
                        <h3>Discount : XXX Thai Baht (XXX %)</h3>
                            ...
                            <c:when test="${not empty sessionScope.user}">
                                ...
                                <c:forEach var="customer" items="${customers.rows}">
                                    <div class="block clear">
                                        ...
                                        <input type="text" name="firstname" value="${customer.first_name}" disabled/> <br>
                                        <label for="comment">Last Name</label>
                                        <input type="text" name="lastname" value="${customer.last_name}" disabled/> <br>
                                        <label for="comment">Email</label>
                                        <input type="text" name="email" value="${customer.email}" disabled/> <br>
