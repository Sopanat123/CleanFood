                    ...
                    <div id="comments">
                        ...
                        <form action="order.jsp" method="POST">
                            <table id="dataCom" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    <c:forEach var="order" items="${myorders.rows}" varStatus="loop">
                                        <tr>
                                            <td>${loop.index + 1}</td>
                                            <td>${order.id}</td>
                                            <td>${order.name}</td>
                                            ...
                                            <td>${order.status}</td>
                                            <td><button class="btn" name="submit" type="submit" value="${order.id}">
